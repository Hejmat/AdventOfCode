...
for i in inp: #Loop for each task in input
    ...
    for n in nums:
        ...
        for ele in lst: #Loop for each combination
            ...
            temp_tar.append(int(new_string, 2)) #Transform binary address to integer and append to first position of actual w index
            temp_tar.append(x) #Append the value to second position of actual w index
            tar.append(temp_tar)
xx = []
xxx = []                
